...
function GeneralInfo(){
  return (
    ...
    >
        <div
        className="flex justify-center m-auto w-[80%]"
      >
          <img className="w-[500px] h-96 object-cover m-2" src={img} alt="Pashupatinath temple form above" />
...
function Geography(){
  return (
    ...
    >
    <div
      className="flex text-center m-auto justify-center w-[80%]"
    >
      <img className="w-[500px] h-96 object-cover m-2" src={mdsInMP} alt="Mandsaur in Madhya Pradesh" />
      <div>
        <h1
          className="text-3xl"
        >Geography</h1>
